                ...
                <div class="container container-navbar">
                    ...
                    <div class="collapse navbar-collapse sl-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav align-items-center gap-1 ms-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="design.php">3d design</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="myDesign.php">our project</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="enjoyUs.php">investor and finance</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="showcase.php">sell or buy project</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="stepform.php">valuation and quotion</a>
                            </li>
                        </ul>
                    </div>
                </div>
